...
**Target Event**: APTA (American Progressive English Association) Bridge Builders Hackathon  
**Target Audience**: Immigrant families, English elders visiting the US, newly arrived parents, non-native English speakers, multi-generational diaspora households.
...
* **Background**: Visiting her son in Plano, TX on a B-2 visitor visa from their home country. Speaks English, very limited English.
...
* **Solution**: ArogyaCard translates 3 taps in English into an authentic nursing clinical triage intake card with "Show to Nurse" fullscreen mode.
...
* **Solution**: EduBridge parses school notices into plain English and exports a 1-click `.ics` calendar file; the Enrollment Wizard verifies immunization compliance against Texas requirements.
...
* **Solution**: Decodr breaks down the clause into 3 clear cards (Plain English meaning, action steps, penalties) and provides a ready-to-send polite reply email.
...
* **Acute Crisis**: Kiran texts in modern slang (*"That math test was cap fr"*), while Grandpa texts in formal English blessings. They love each other but struggle to maintain a deep connection.
...
* **FR-2.1 (AI Form Field Explainer)**: Explains confusing boxes on government forms (W-4, county exemptions, fee waivers) in plain English with sample entries and common mistake warnings.
...
* **FR-3.1 (Pre-Visit Phrasebook & Q&A Checklist)**: Converts symptom descriptions into side-by-side English/English questions for the patient to ask their physician, plus anticipated questions the doctor will ask.
* **FR-3.2 (Clinical Doctor Visit Intake Card - Live)**: Visual English symptom and pain slider (1–10) converted into a standardized US nursing clinical triage sheet (Chief complaint, HPI summary, medications, triage urgency) with "Show to Nurse" fullscreen mode and clinical audio.
...
* **FR-4.2 (Immigrant Public Transit Explainer)**: Plain-language, step-by-step route directions (which bus/train, fare payment in English, transfer stops, cord-pull etiquette) for non-driving immigrants.
...
* **FR-6.1 (Clinical Immigrant Business Directory)**: Community-curated directory of regional immigrant businesses (catering, saree alterations, groceries, tax consulting) searchable by language spoken (English, Hindi, Tamil).
...
* **FR-7.1 (Generational Slang & Idiom Bridge Messenger)**: Bidirectional chat engine that preserves emotional warmth (*Vatsalyam*) while translating between American teen slang and formal English blessings.
* **FR-7.2 (Shared Clinical Family Board)**: Simple, high-contrast shared calendar and chore board displaying tasks in English and English side-by-side for multi-generational homes.

### TRACK 8: Stories and Traditions
* **FR-8.1 (Katha Oral Folklore Keeper)**: 1-tap English voice recording transcribed, translated into lyrical English storybook prose, and formatted into an illustrated digital memory card with cultural glossaries.
...
* **NFR-4 (Accessibility & Typography)**: High-contrast color contrast ratios ($\ge 4.5:1$), tap targets $\ge 48\text{px}$, and native typography via Google Fonts *Noto Sans English* to ensure diacritic integrity.
...
| **Family Bonds (Track 7 & 8)** | Generational language erosion and lost folklore | **Clinical chat, illustrated audio storybooks** | **Permanent preservation of cultural heritage** |
